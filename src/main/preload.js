...
contextBridge.exposeInMainWorld('pet', {
  ...
  openLarkWorkbench: (request = {}) => ipcRenderer.invoke('pet:open-lark-workbench', request),
  onWorkbenchNavigate: (cb) => ipcRenderer.on('pet:workbench-navigate', (_e, request) => cb(request)),
  ...
  createAgentTaskGroup: (request) => ipcRenderer.invoke('pet:agent-task-create-group', request),
  setAgentTaskProgress: (request) => ipcRenderer.invoke('pet:agent-task-set-progress', request),
  deleteAgentTaskGroup: (request) => ipcRenderer.invoke('pet:agent-task-delete-group', request),
  detachAgentSession: (request) => ipcRenderer.invoke('pet:agent-task-detach-session', request),
  ignoreAgentSession: (request) => ipcRenderer.invoke('pet:agent-task-ignore-session', request),
  addAgentTaskTodo: (request) => ipcRenderer.invoke('pet:agent-task-add-todo', request),
  updateAgentTaskTodo: (request) => ipcRenderer.invoke('pet:agent-task-update-todo', request),
  deleteAgentTaskTodo: (request) => ipcRenderer.invoke('pet:agent-task-delete-todo', request),
